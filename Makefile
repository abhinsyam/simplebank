...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/abhinsyam/simplebank/db/sqlc Store

.PHONY: createdb postgres dropdb migrateup migratedown migrateup1 migratedown1 sqlc server mock